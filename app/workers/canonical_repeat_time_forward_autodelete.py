...
class CanonicalRepeatTimeForwardAutodeleteWorker(PublicationAutodeleteWorker):
    """Dedicated started-only dependency for ordered repeat+time+forward DELETE."""
    ...
    @property
    def repeat_time_forward_available(self) -> bool:
        return bool(self._started and self.allow_repeat_time_forward)
    ...
    async def _delete_with_operation_session(
        ...
        *,
        ...
        return await CanonicalRepeatTimeForwardAutodeleteService(
            operation_session,
