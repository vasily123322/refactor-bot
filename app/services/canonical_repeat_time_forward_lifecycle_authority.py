...
class CanonicalRepeatTimeForwardLifecycleAuthority:
    publication_id: int
...
class CanonicalRepeatTimeForwardLifecycleAuthorityService:
    """Provider-free terminal proof for exact ordered repeat+time+forward state."""
    ...
    async def lock_and_prove(
        ...
        publication_id: int,
        *,
        allow_time_forward: bool = False,
    ) -> CanonicalRepeatTimeForwardLifecycleAuthority | None:
        if not bool(allow_time_forward):
            return None
        ...
        return CanonicalRepeatTimeForwardLifecycleAuthority(
