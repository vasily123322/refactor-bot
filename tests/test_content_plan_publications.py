...
def test_editor_back_restores_canonical_publication_without_post_task(monkeypatch) -> None:
    async def run() -> None:
        from app.bot.routers import content_plan_publications as publication_router
        ...
        assert opened == ["cp_open_publication:77:2026-08-10"]
